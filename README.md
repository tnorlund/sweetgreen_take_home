...
# Run checks (lightweight custom validators)
...
- Dependencies are managed via `pyproject.toml` (build backend: hatchling). Great Expectations was removed to keep the runtime lean for this single CSV; the CLI uses custom validators for the specified business rules.
